                                ...
                                <div class="col-12 col-md-8 pt-4 pt-md-0">
                                    <div class="tab-content p-0 ps-md-3">
                                        ...
                                        <div class="tab-pane fade show active" id="restock" role="tabpanel">
                                            ...
                                            <div>
                                                <p class="mb-1">
                                                    <span class="fw-semibold text-heading">Product in stock now: </span>
                                                    <span>54</span>
                                                </p>
                                                <p class="mb-1">
                                                    <span class="fw-semibold text-heading">Product in transit: </span>
                                                    <span>390</span>
                                                </p>
                                                <p class="mb-1">
                                                ...
                                                <p class="mb-1">
                                                    <span class="fw-semibold text-heading">Total stock over lifetime:
                                                    </span>
                                                    <span>2430</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="shipping" role="tabpanel">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    See our <a href="javascript:void(0);">Delivery terms and conditions</a>
                                                    for details
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 col ecommerce-select2-dropdown">
                                <label class="form-label mb-1 d-flex justify-content-between align-items-center"
                                    for="category-org">
                                    <span>Category</span><a href="{{'categorylist'}}" class="fw-medium">Add new
                                        category</a>
                                </label>
