                        ...
                        <form action="{{route('profile.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input class="form-control" value="{{auth()->user()->name}}" type="text" id="firstName" name="name"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" value="{{auth()->user()->email}}" type="text" id="email" name="email"
                                        value="john.doe@example.com" placeholder="john.doe@example.com" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="organization" class="form-label">Organization</label>
                                    <input type="text" class="form-control" id="organization" name="organisation"
                                ...
                                <div class="mb-3 col-md-12">
                                    <div class="button-wrapper">
                                        <label for="upload" class="btn btn-primary me-2 mb-3" tabindex="0">
                                            ...
                                            <input type="file" id="upload" name="profilepic" class="account-file-input" hidden
